...
Trash=$(ls -lt ~/.local/share/Trash/ | grep files | awk '{print $4, $5, $6, $7, $8, $9}')
ModsFA=$(ls -lt ~/.minecraft/ | grep mods | awk '{print $4, $5, $6, $7, $8, $9}')
ModsF18=$(ls -lt ~/.minecraft/mods/ | grep "1.8.9" | awk '{print $4, $5, $6, $7, $8, $9}')
ModsF17=$(ls -lt ~/.minecraft/mods/ | grep "1.7.10" | awk '{print $4, $5, $6, $7, $8, $9}')
Versions=$(ls -lt ~/.minecraft/ | grep versions | awk '{print $4, $5, $6, $7, $8, $9}')
{
sleep 2
...
dir=$(pwd)
clear
echo -e "1/4 - Starting External scan... [This might take a while]"
echo "
                 Detections
-------------------------------------------
" >> /tmp/777.txt
...
echo -e "2/4 Parsing results...!"
if [[ $ExplicitB9Check == *'476303'* ]]; then
echo -e User has been caught using Explicit \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $FenixCheck == *'945117'* ]]; then
echo -e User has been caught using Fenix \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $GhostSenseCheck == *'232737'* ]]; then
echo -e User has been caught using Ghost Sense \(Check A\) >> /tmp/777.txt 
echo "
" >> /tmp/777.txt
fi
if [[ $NebulaCheck == *'705585'* ]]; then
echo -e User has been caught using Nebula God Client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $BapeCheck == '*1489573'* ]]; then
echo -e User has been caught using Bape or Cracked vape \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $TimeChangerCheck1 == *'29284'* ]]; then
echo -e User has been caught using TimeChanger client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
...
echo -e User has been caught using Raven B2 \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $RavenB2Check2 == *'116'* ]]; then
echo -e User has been caught using Raven B2 \(Check B\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $RavenB1Check == *'54620'* ]]; then
echo -e User has been caught using Raven B1 \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $GucciClientCheck == *'55628'* ]]; then
echo -e User has been caught using Gucci Client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
...
echo -e User has been caught using Incognito Client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
...
echo -e User has been caught using Onyx Client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $SakeCheck == *'588131'* ]]; then
echo -e User has been caught using Sake Client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $SkilledCheck == *'251173'* ]];then
echo -e User has been caught using Skilled B2 \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $SkilledB1Check == *'239784'* ]]; then
echo -e User has been caught using Skilled B1 \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $ReachModCheck == *"4631"* ]]; then
echo -e User has been caught using a reach mod \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $ReachModCheck2 == *'5996'* ]]; then
echo -e User has been caught using a reach mod \(Check B\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $AzuryaCheck == *'69653'* ]]; then
echo -e User has been caught using Azurya Client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $RemoveHitDelay == *'7179'* ]]; then
echo -e User has been caught using a mod that removes the 1.8.9 hit delay. >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $ButterflyMod == *'3785'* ]]; then
echo -e User has been caught using a mod that simulates butterfly clicks \(BANNABLE\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $GhostClient == *'236695'* ]]; then
echo -e User has been caught using a generic Ghost Client \( Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $LiquidBounce == *'7245326'* ]]; then
echo -e User is using LiquidBounce \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $SativaCheck == *'951771'* ]]; then
echo -e User has been caught using Sativa Client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $UboaCheck == *'221595'* ]]; then
echo -e User has been caught using Uboa Client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $VeneCheck == *'291968'* ]]; then
echo -e User has been caught using Vene Client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $WillyCheck == *'3461783'* ]]; then
echo -e User has been caught using Willy Client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $SkilledV3 == *'896670'* ]]; then
echo -e User has been caught using Skilled Client V3 \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $RavenV2 == *'210532'* ]]; then
echo -e User has been caught using Raven Client V2 \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $FDPClient == *'15173506'* ]]; then
echo -e User has been caught using FDP Client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $Rmodule == *'Reach'* ]]; then
echo -e User has been flagged for Generic Reach module \(Check C\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $Vmodule == *'Velocity'* ]]; then
echo -e User has been flagged for Generic Velocity module \(Check C\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $Vape325 == *'1485973'* ]]; then
echo -e User has been caught using Vape 3.25 Cracked \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $RavenPlusEXP == *'2952819'* ]]; then
echo -e User has been caught using Raven b+ [experimental client] \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $RavenPlus == *'2878145'* ]]; then
echo -e User has been caught using Raven b+ Client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
...
echo -e User has been caught using Raven Client V3 \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $uboa == *'221595'* ]]; then
...
if [[ $Vea == *'38790'* ]]; then
echo -e User has been caught using Vea Client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi 
if [[ $Sumo == *'155754'* ]]; then
echo -e User has been caught using Sumo Ghost Client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $Crystal == *'296751'* ]]; then
echo -e User has been caught using Crystal Ghost Client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi 
...
echo -e User has been caught using TimeChanger client \(Check B\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
...
echo -e User has been flagged for Generic internal file deletion \(Check B\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
...
echo -e User has been flagged for Cyanide ghost client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $trump7 == *'2304240'* ]]; then
echo -e User has been flagged for Trump ghost client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $onik7 == *'149594'* ]]; then
echo -e User has been flagged for Onik ghost client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $Vea7 == *'38790'* ]]; then
...
echo -e User has been caught using generic xRay texture pack \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
...
if [[ $xRay4G == *'.zip'* ]]; then
echo -e User has been caught generic file xRay texture pack \(Check D\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi    
...
echo -e User has been flagged for Generic External Autoclicker [XClicker] \(Check D\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $Clicker7 == *'.jar'* ]]; then
echo -e User has been flagged for Generic External Autoclicker [7CLicker] \(Check D\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $Vene == *'.jar'* ]]; then
echo -e User has been flagged for Generic External Autoclicker [VeneClicker] \(Check D\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $JnativeHook == *'JNativeHook'* ]]; then
echo -e User has been flagged for Generic autoclicker traces [JNAtiveHook] \(Check D\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $lolxd == *'.jar'* ]]; then
echo -e User has been flagged for Generic External Autoclicker [lolxd v4.2] \(Check D\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $epoch == *'.py'* ]]; then
echo -e User has been flagged for Generic External Autoclicker [epoch] \(Check D\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $users2 == *'=2'* ]]; then
echo -e User has been flagged for 2 logged users \(Check C\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $JavaAC == *'.jar'* ]]; then
echo -e User has been flagged for Generic Autoclicker [literally has no name] \(Check D\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $GenericRecorder == *'Recorder'* ]]; then
echo -e User has been flagged for Generic Screen recorder in instance \(Check C\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $OBS == *'Sl'* ]]; then
echo -e User has been flagged for Generic Screen recorder in instance [OBS] \(Check C\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $simplescreenrecorder == *'simplescreenrecorder --logfile'* ]]; then
echo -e User has been flagged for Generic Screen recorder in instance [Simple Screen Recorder] \(Check C\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $Kazam == *'?'* ]]; then
echo -e User has been flagged for Generic Screen recorder in instance [Kazam] \(Check C\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $GenericAC == *'.jar'* ]]; then
echo -e User has been flagged for Generic Autoclicker [Generic name] \(Check C\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $lemonade == *'.jar'* ]]; then
echo -e User has been caught using Lemonade Client \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $HuzuniVIP == *'.jar'* ]]; then
echo -e User has been caught using Huzuni VIP 3.5 \(Check A\) >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
...
if [[ $GCheckDeletedFile == *'deleted'* ]]; then
echo -e "User has been flagged for Generic internal file deletion (MOD) (Check B)" >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $GCheckDeletedFile2 == *'deleted'* ]]; then
echo -e "User has been flagged for Generic internal file deletion (Resource Pack) (Check B)" >> /tmp/777.txt
echo "
" >> /tmp/777.txt
fi
if [[ $GRmodule == *'Reach'* ]]; then
...
-------------------------------------------
" >> /tmp/777.txt
echo "Recycle Bin: $Trash" >> /tmp/777.txt
echo """Mods Folder
1.7.10: $ModsF17
1.8.9: $ModsF18 
General: $ModsFA 
""" >> /tmp/777.txt
echo "Versions folder: $VersionsF" >> /tmp/777.txt
echo -e "
" >> /tmp/777.txt
clear
echo -e "
...
------------------------------------------- 
" >> /tmp/777.txt
nmcli con show --active | awk '{print $1}' | grep -i vpn >> /tmp/777.txt
echo -e "
" >> /tmp/777.txt
clear
echo -e "
...
" >> /tmp/777.txt
who -H >> /tmp/777.txt
echo -e Two same names are not double users! >> /tmp/777.txt
echo -e "
" >> /tmp/777.txt
echo -e "
Posible alts 
-------------------------------------------
" >> /tmp/777.txt
cat ~/.minecraft/launcher_accounts.json | grep name | awk '{print $3}' |  tr '"' ' ' | tr ',' ' ' >> /tmp/777.txt
echo -e "
" >> /tmp/777.txt
echo -e "
Hardware ID
------------------------------------------- 
" >> /tmp/777.txt
echo -e Mac Address: && ifconfig -a | grep ether | awk '{print $2}' >> /tmp/777.txt
...
##curl -H "Accept: application/json" -H "Content-Type:multipart/form-data" -X POST -F "file=@/tmp/777.txt" -F "payload_json={\"content\":\"$USER Scan (linux)\"}" webhook link
clear
} &> /dev/null
echo -e External check done...!
echo -e Running internal check...!
exit
